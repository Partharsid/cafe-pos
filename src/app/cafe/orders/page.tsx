              ...
              <div className="flex gap-1.5 mt-3 pt-3 border-t border-border">
                {order.status === "pending" && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-secondary/15 text-secondary hover:bg-secondary/25 transition-colors"
                  >
                ...
                {(order.status === "pending" || order.status === "preparing") && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-accent/15 text-accent hover:bg-accent/25 transition-colors"
                  >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-chart-4/15 text-chart-4 hover:bg-chart-4/25 transition-colors"
                >
